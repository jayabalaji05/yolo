       ...
       switch(this.id) {
           case "login-form":
               ...
               if ($lg_username == "niit"&&$lg_password == "niit") {
                   ...
                   msgChange($('#div-loginS-msg'), $('#icon-login-msg'), $('#text-login-msg'), "error", "glyphicon-remove", "Login error");
               }
               return false;
               break;
           case "lost-form":
           ...
           case "register-form":
               ...
               if ($rg_username == "ERROR") {
                   ...
                   msgChange($('#div-register-msg'), $('#icon-register-msg'), $('#text-register-msg'), "success", "glyphicon-ok", "Registered Successfully");
               }
               return false;
               break;
           default:
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
   ...
   <c:if test="${empty SuccessMessage}">
      <li><a href="#" data-toggle="modal" data-target="#login-modal">Sign in <span class="glyphicon glyphicon-user"></span></a></li>
                ...
                <form id="login-form" action="welcome" method="POST">
		                <div class="modal-body">
				    		<div id="div-login-msg">
                                ...
                                <span id="text-login-msg">Type your user name and password.</span>
                            </div>
				    		<input id="login_username" name="userID" class="form-control" type="text" placeholder="Username" required>
                   ...
                   <form id="register-form" style="display:none;">
            		    <div class="modal-body">
                            ...
                            <input id="password" class="form-control" type="password" required data-toggle="popover" title="Password Strength" placeholder="Password" required>
            			</div>
		    		    <div class="modal-footer">
                            <div>
