...
promote their personal projects</p>
            <div class="btns">
                ...
                <a class="btn btn-primary btn-lg" href="birthday_suggestion">Birthdays</a>
                <a class="btn btn-primary btn-lg" href="http://themes.3rdwavemedia.com/" target="_blank">Surprises</a>
            </div>
            <br><br>
        </div><!--//container-->
    </section><!--//promo-->	    
    ...
    <section class="best-selling">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h1><span class="t-color-2">Featured Products</span>
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<div class="row">
								<div class="col-sm-6">
									<div class="media">
										<div class="media-left text-center"><img class="img-responsive" src="images/e-add-1.jpg" alt=""></div>
		...
		<section class="product-info">
			<div class="container">
				<div class="row">	
					<div class="col-sm-4">
						<h1><span class="t-color-3">New Arrival</span></h1>
					...
					<div class="col-sm-4">
						<h1><span class="t-color-4">Special Product</span></h1>
					...
					<div class="col-sm-4">
						<h1><span class="t-color-5">Top Rated</span></h1>
